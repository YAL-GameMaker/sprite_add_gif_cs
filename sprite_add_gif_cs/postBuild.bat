...
set extName=sprite_add_gif_cs
set dllName=sprite_add_gif_cs
set gmlDir14=%solutionDir%sprite_add_gif_cs.gmx
set gmlDir22=%solutionDir%sprite_add_gif_cs_yy
set gmlDir23=%solutionDir%sprite_add_gif_cs_23
